...
```
aws ecr get-login-password --region eu-central-1 --profile [PROFILE] | docker login --username AWS --password-stdin 211125526255.dkr.ecr.eu-central-1.amazonaws.com
```
...
```
docker tag backend-loadtest:latest 211125526255.dkr.ecr.eu-central-1.amazonaws.com/backend-loadtest:latest
```

```
docker push 211125526255.dkr.ecr.eu-central-1.amazonaws.com/backend-loadtest:latest
```
